...
Background = Color3.fromRGB(60, 20, 35),
Topbar = Color3.fromRGB(75, 25, 45),
Shadow = Color3.fromRGB(90, 30, 55),

NotificationBackground = Color3.fromRGB(85, 30, 50),
NotificationActionsBackground = Color3.fromRGB(70, 25, 45),

TabBackground = Color3.fromRGB(75, 25, 45),
TabStroke = Color3.fromRGB(100, 40, 60),
TabBackgroundSelected = Color3.fromRGB(120, 50, 80),
TabTextColor = Color3.fromRGB(240, 190, 210),
SelectedTabTextColor = Color3.fromRGB(255, 220, 240),

ElementBackground = Color3.fromRGB(70, 25, 45),
ElementBackgroundHover = Color3.fromRGB(85, 30, 50),
SecondaryElementBackground = Color3.fromRGB(100, 35, 60),
ElementStroke = Color3.fromRGB(120, 50, 80),
SecondaryElementStroke = Color3.fromRGB(135, 60, 90),

SliderBackground = Color3.fromRGB(90, 30, 55),
SliderProgress = Color3.fromRGB(220, 90, 130),
SliderStroke = Color3.fromRGB(240, 110, 150),

ToggleBackground = Color3.fromRGB(75, 25, 45),
ToggleEnabled = Color3.fromRGB(240, 100, 140),
ToggleDisabled = Color3.fromRGB(120, 60, 80),
ToggleEnabledStroke = Color3.fromRGB(210, 90, 130),
ToggleDisabledStroke = Color3.fromRGB(150, 70, 100),
ToggleEnabledOuterStroke = Color3.fromRGB(180, 80, 120),
ToggleDisabledOuterStroke = Color3.fromRGB(110, 55, 75),

DropdownSelected = Color3.fromRGB(100, 35, 60),
DropdownUnselected = Color3.fromRGB(85, 30, 50),

InputBackground = Color3.fromRGB(90, 30, 55),
InputStroke = Color3.fromRGB(130, 55, 85),
PlaceholderColor = Color3.fromRGB(235, 180, 200),
	...
	Topbar = Color3.fromRGB(50, 50, 70),
	Shadow = Color3.fromRGB(30, 30, 45),

	NotificationBackground = Color3.fromRGB(50, 50, 70),
	NotificationActionsBackground = Color3.fromRGB(60, 60, 80),

	TabBackground = Color3.fromRGB(45, 45, 60),
	TabStroke = Color3.fromRGB(70, 70, 90),
	TabBackgroundSelected = Color3.fromRGB(60, 60, 85),
	TabTextColor = Color3.fromRGB(160, 140, 255),
	SelectedTabTextColor = Color3.fromRGB(120, 100, 220),

	ElementBackground = Color3.fromRGB(45, 45, 60),
	ElementBackgroundHover = Color3.fromRGB(55, 55, 75),
	SecondaryElementBackground = Color3.fromRGB(40, 40, 55),
	ElementStroke = Color3.fromRGB(70, 70, 90),
	SecondaryElementStroke = Color3.fromRGB(80, 80, 100),

	SliderBackground = Color3.fromRGB(50, 50, 70),
	SliderProgress = Color3.fromRGB(116, 100, 255),
	SliderStroke = Color3.fromRGB(90, 80, 220),

	ToggleBackground = Color3.fromRGB(50, 50, 70),
	ToggleEnabled = Color3.fromRGB(116, 100, 255),
	ToggleDisabled = Color3.fromRGB(60, 60, 80),
	ToggleEnabledStroke = Color3.fromRGB(90, 80, 220),
	ToggleDisabledStroke = Color3.fromRGB(100, 100, 120),
	ToggleEnabledOuterStroke = Color3.fromRGB(70, 60, 190),
	ToggleDisabledOuterStroke = Color3.fromRGB(120, 120, 140),

	DropdownSelected = Color3.fromRGB(60, 60, 80),
	DropdownUnselected = Color3.fromRGB(45, 45, 60),

	InputBackground = Color3.fromRGB(55, 55, 75),
	InputStroke = Color3.fromRGB(80, 80, 100),
...
-- Simplified script without version checking
if not Rayfield then
    error("Elevate library could not be loaded.")
end
...
local function LoadConfiguration(Configuration)
	...
	for FlagName, Flag in pairs(RayfieldLibrary.Flags) do
		...
		if FlagValue then
			...
			warn("Elevate | Unable to find '"..FlagName.. "' in the save file.")
...
function RayfieldLibrary:Notify(data) -- action e.g open messages
	task.spawn(function()
		...
		if data.Actions then
			warn('Elevate | Not seeing your actions in notifications?')
...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobileSizing then
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping 'Show Elevate'.", Duration = 7, Image = 4400697855})
		else
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "Elevate"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "Interface Suite"

	if Settings.LoadingTitle ~= "Elevate Interface Suite" then
		LoadingFrame.Version.Text = "Elevate UI"
	end
    ...
    makeDraggable(Main, Elements, false, 255)
    makeDraggable(Main, LoadingFrame, false, 255)
    makeDraggable(Main, TabList, false, 255)
	...
	if (Settings.KeySystem) then
		...
		if Settings.KeySettings.GrabKeyFromSite then
			for i, Key in ipairs(Settings.KeySettings.Key) do
				...
				if not Success then
					print("Elevate | "..Key.." Error " ..tostring(Response))
					warn('Check docs.sirius.menu for help with Elevate specific development.')
				end
			end
		end
		...
		if not Passthrough then
			...
			KeyMain.Size = UDim2.new(0, 467, 0, 300)
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					print("Elevate | "..ButtonSettings.Name.." Callback Error " ..tostring(Response))
					warn('Check docs.sirius.menu for help with Elevatespecific development.')
					task.wait(0.5)
					Button.Title.Text = ButtonSettings.Name
		...
		function Tab:CreateInput(InputSettings)
			...
			Input.InputFrame.InputBox.FocusLost:Connect(function()
				...
				if not Success then
					...
					print("Elevate | "..InputSettings.Name.." Callback Error " ..tostring(Response))
				...
				for _, Option in ipairs(DropdownSettings.Options) do
					...
					DropdownOption.Interact.MouseButton1Click:Connect(function()
						...
						if not Success then
							...
							print("Elevate | "..DropdownSettings.Name.." Callback Error " ..tostring(Response))
							warn('Check docs.sirius.menu for help with Elevate specific development.')
							task.wait(0.5)
							Dropdown.Title.Text = DropdownSettings.Name
							TweenService:Create(Dropdown, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
				...
				elseif KeybindSettings.CurrentKeybind ~= nil and (input.KeyCode == Enum.KeyCode[KeybindSettings.CurrentKeybind] and not processed) then -- Test
					...
					if not KeybindSettings.HoldToInteract then
						...
						if not Success then
							...
							print("Elevate | "..KeybindSettings.Name.." Callback Error " ..tostring(Response))
							warn('Check docs.sirius.menu for help with Elevate specific development.')
							task.wait(0.5)
							Keybind.Title.Text = KeybindSettings.Name
							TweenService:Create(Keybind, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			Toggle.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					print("Elevate | "..ToggleSettings.Name.." Callback Error " ..tostring(Response))
					warn('Check docs.sirius.menu for help with Elevate specific development.')
					task.wait(0.5)
					Toggle.Title.Text = ToggleSettings.Name
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					...
					if SLDragging then
						...
						if SliderSettings.CurrentValue ~= NewValue then
							...
							if not Success then
								...
								print("Elevate | "..SliderSettings.Name.." Callback Error " ..tostring(Response))
								warn('Check docs.sirius.menu for help with Elevate specific development.')
								task.wait(0.5)
								Slider.Title.Text = SliderSettings.Name
								TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
	...
	if CEnabled then
		...
		local success, result = pcall(function()
			...
			if isfile then 
				...
				notified = true
				RayfieldLibrary:Notify({Title = "Elevate Configurations", Content = "We couldn't enable Configuration Saving as you are not using file supported software.", Image = 4384402990})
			end
		end)
		
		if success and loaded and not notified then
			RayfieldLibrary:Notify({Title = "Elevate Configurations", Content = "The configuration file for this script has been loaded from a previous session.", Image = 4384403532})
		elseif not success and not notified then
			warn('Elevate Configurations Error | '..tostring(result))
			RayfieldLibrary:Notify({Title = "Elevate Configurations", Content = "We've encountered an issue loading your configuration correctly.\n\nCheck the Developer Console for more information.", Image = 4384402990})
		end
	end
end
...
if useStudio then
	...
	local Window = RayfieldLibrary:CreateWindow({
		Name = "Elevate Example Window",
		LoadingTitle = "Elevate Interface Suite",
		Theme = 'Default',
		...
		KeySettings = {
			...
			FileName = "Key", -- It is recommended to use something unique as other scripts using Elevate may overwrite your key file
			SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
			GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Elevate to get the key from
	...
	--RayfieldLibrary:Notify({Title = "Elevate Interface", Content = "Welcome to Rayfield. These - are the brand new notification design for Rayfield, with custom sizing and Elevate calculated wait times.", Image = 4483362458})
