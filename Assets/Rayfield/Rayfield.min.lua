...
local RayfieldLibrary = {
	...
	Theme = {
		...
		DarkAmberlight = {
	TextColor = Color3.fromRGB(60, 90, 30),
	Background = Color3.fromRGB(235, 255, 210),
	Topbar = Color3.fromRGB(225, 245, 190),
	Shadow = Color3.fromRGB(200, 230, 170),

	NotificationBackground = Color3.fromRGB(240, 255, 220),
	NotificationActionsBackground = Color3.fromRGB(245, 255, 230),

	TabBackground = Color3.fromRGB(230, 250, 210),
	TabStroke = Color3.fromRGB(200, 230, 180),
	TabBackgroundSelected = Color3.fromRGB(220, 245, 170),
	TabTextColor = Color3.fromRGB(80, 100, 40),
	SelectedTabTextColor = Color3.fromRGB(50, 80, 20),

	ElementBackground = Color3.fromRGB(240, 255, 225),
	ElementBackgroundHover = Color3.fromRGB(250, 255, 235),
	SecondaryElementBackground = Color3.fromRGB(230, 250, 210),
	ElementStroke = Color3.fromRGB(200, 230, 180),
	SecondaryElementStroke = Color3.fromRGB(190, 220, 170),

	SliderBackground = Color3.fromRGB(210, 240, 170),
	SliderProgress = Color3.fromRGB(140, 220, 60),
	SliderStroke = Color3.fromRGB(160, 200, 80),

	ToggleBackground = Color3.fromRGB(235, 255, 220),
	ToggleEnabled = Color3.fromRGB(140, 220, 60),
	ToggleDisabled = Color3.fromRGB(170, 190, 150),
	ToggleEnabledStroke = Color3.fromRGB(120, 200, 50),
	ToggleDisabledStroke = Color3.fromRGB(150, 170, 130),
	ToggleEnabledOuterStroke = Color3.fromRGB(100, 180, 40),
	ToggleDisabledOuterStroke = Color3.fromRGB(120, 140, 110),

	DropdownSelected = Color3.fromRGB(245, 255, 235),
	DropdownUnselected = Color3.fromRGB(230, 250, 210),

	InputBackground = Color3.fromRGB(245, 255, 230),
	InputStroke = Color3.fromRGB(200, 230, 180),
	PlaceholderColor = Color3.fromRGB(110, 130, 90)
},
